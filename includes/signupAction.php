...
$checkIfUserExists=mysql_fetch_array(mysql_query("SELECT * FROM users WHERE username='$username'"));
...
if($checkIfUserExists==NULL)
{
	...
	else
	{
		...
		echo '<div class="spacerLarge">Hello,World!</div>';
		echo '<div class="col-sm-12" style="text-align: center;">';
		echo '<div class="heading3">An account with this username already exists.<br/>Please login instead.</div>';
		echo '</div>';
		echo '<div class="spacerLarge">Hello,World!</div>';
		echo '<div class="col-xs-12 text-center">';
		echo '<a href="login.php" > <input type="button" class="button" value="Login" /> </a>';	
		echo '</div>';
		echo '<div class="spacerLarge">Hello,World!</div>';
		echo '<div class="spacer">Hello,World!</div>';
		echo '</div>'; //bodyAndSidebar
