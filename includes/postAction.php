...
$query="INSERT INTO tbtable(postTitle,postedBy,postdate,picture,description,username) VALUES('$pTitle','$pBy','$date','$pic_name','$desc','$user')";  //changed descFormatted to $desc
